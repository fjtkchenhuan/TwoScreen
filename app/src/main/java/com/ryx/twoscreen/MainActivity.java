    ...
    private Handler mHandler = new Handler() {
        ...
        public void handleMessage(Message msg) {
            ...
            switch (msg.what) {
                ...
                case WRITE_1_TO_STATE:
                    //Log.d("342142342", "888888_____");
                    try {
                        writeFile("1");
                    } catch (IOException e) {
                        e.printStackTrace();
...
//            }
    ...
    class MySurfaceViewTouchListener implements View.OnTouchListener {
        ...
        public boolean onTouch(View v, MotionEvent event) {
            ...
            // }
            // mMotionEv = event;
            //  mainSurface.dispatchTouchEvent(mMotionEv);
            return false;
        }
    }
    ...
    // 写文件
    public void writeFile(String str) throws IOException, InterruptedException {
//        Log.d(TAG,"str:" + str);
//        if (str.equals("0")) {
//            mHandler.sendEmptyMessageDelayed(WRITE_1_TO_STATE, 200);
//        }
...
//        if (str.equals("0")) {
//            do_exec("busybox echo 0 > /sys/class/hdmi/hdmi/attr/state");
//            Log.d(TAG,"busybox echo 0 > /sys/class/hdmi/hdmi/attr/state");
//        }  else {
//            do_exec("busybox echo 1 > /sys/class/hdmi/hdmi/attr/state");
//            Log.d(TAG,"busybox echo 1 > /sys/class/hdmi/hdmi/attr/state");
//        }
    }
